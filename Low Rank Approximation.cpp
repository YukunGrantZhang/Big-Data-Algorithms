...
int main()
{
	...
	float A[r][c] = {{3, 2, 6, 1, 9, 1, 5, 9, 1, 2, 5},
			         {1, 8, 5, 3, 1, 9, 1, 6, 3, 3, 3},
					 {2, 5, 1, 9, 3, 8, 1, 3, 8, 8, 8},
					 {5, 1, 6, 8, 3, 5, 6, 1, 1, 5, 1},
					 {2, 3, 8, 1, 5, 1, 1, 3, 2, 1, 6},
					 {1, 8, 3, 2, 1, 8, 2, 9, 5, 9, 1},
					 {5, 1, 8, 1, 2, 3, 5, 1, 3, 1, 9},
					 {2, 3, 6, 1, 5, 8, 5, 9, 1, 2, 1}};
	...
	int d = int(float(k_rank) / epsilon);
